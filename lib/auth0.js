...
export function getAuth0() {
  if (!auth0Instance) {
    ...
    cfg.domain ||= process.env.AUTH0_DOMAIN;
    cfg.clientId ||= process.env.AUTH0_CLIENT_ID;
    cfg.clientSecret ||= process.env.AUTH0_CLIENT_SECRET;
    cfg.secret ||= process.env.AUTH0_SECRET;
    cfg.baseURL ||= process.env.APP_BASE_URL;

    const hasRequired = cfg.domain && cfg.clientId && cfg.secret;
